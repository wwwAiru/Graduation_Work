...
<br>
<br>
<b>10. У администратора(HEAD_MANAGER) реализован функционал: добавление инвестиционных продуктов(вкладов), редактирование, деактивация, удаление. Администратор может назначать роли клиентам на странице "Клиенты". На странице "Деактивированные продукты" администратор может активировать архивный вклад в режиме редактирования (после этого он будет отображаться на странице "Инвестиционные продукты"), либо удалить безвозвратно.  </b>
